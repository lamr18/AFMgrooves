function outputArg1=profile_plot(C,perp_line_pix,perp_line_len)
...
geom_en(1,:)=[(2*w_l) d_l beta_l (2*halfdi_l) en_ratio_l]; %combine all the info
...
geom_en(2,:)=[(2*w_r) d_r beta_r (2*halfdi_r) en_ratio_r]; %combine all the info
...
geom_en(3,:)=[w_lr d_lr beta_lr (2*halfdi_lr) en_ratio_lr]; %combine all the info
